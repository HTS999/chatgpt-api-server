...
require (
	github.com/cool-team-official/cool-admin-go/contrib/drivers/mysql v1.5.5
	github.com/cool-team-official/cool-admin-go/contrib/drivers/sqlite v1.5.5
	github.com/cool-team-official/cool-admin-go/cool v1.5.5
	github.com/cool-team-official/cool-admin-go/modules/base v1.5.5
